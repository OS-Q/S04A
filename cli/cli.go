...
import (
	...
	"github.com/OS-Q/S04A/cli/board"
	"github.com/OS-Q/S04A/cli/burnbootloader"
	"github.com/OS-Q/S04A/cli/cache"
	"github.com/OS-Q/S04A/cli/compile"
	"github.com/OS-Q/S04A/cli/completion"
	"github.com/OS-Q/S04A/cli/config"
	"github.com/OS-Q/S04A/cli/core"
	"github.com/OS-Q/S04A/cli/daemon"
	"github.com/OS-Q/S04A/cli/debug"
	"github.com/OS-Q/S04A/cli/errorcodes"
	"github.com/OS-Q/S04A/cli/feedback"
	"github.com/OS-Q/S04A/cli/generatedocs"
	"github.com/OS-Q/S04A/cli/globals"
	"github.com/OS-Q/S04A/cli/lib"
	"github.com/OS-Q/S04A/cli/outdated"
	"github.com/OS-Q/S04A/cli/output"
	"github.com/OS-Q/S04A/cli/sketch"
	"github.com/OS-Q/S04A/cli/update"
	"github.com/OS-Q/S04A/cli/upgrade"
	"github.com/OS-Q/S04A/cli/upload"
	"github.com/OS-Q/S04A/cli/version"
